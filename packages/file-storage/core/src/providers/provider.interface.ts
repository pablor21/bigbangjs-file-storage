...
export interface IStorageProvider<BucketType extends IBucket = Bucket, BucketConfigType extends BucketConfigOptions = any, NativeResponseType = any> extends EventEmitter {
   ...
   */
  addBucket(name: string, config?: BucketConfigType): Promise<StorageResponse<BucketType, NativeResponseType>>;
  /**
